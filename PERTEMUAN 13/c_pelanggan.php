 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tambah Data Pelanggan</i></h1>
     ...
     <div class="card card-info">
              ...
              <h4>Kode Pelanggan</h4>
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="tgl_lahir" name="tgl_lahir" type="date" class="form-control" placeholder="Tanggal Lahir">
                </div>
                ...
                <div class="input-group mb-3">
                  ...
                  <select id="kartu_id" name="kartu_id" class="form-control">
                          <option class="text-muted">-- Jenis Kartu --</option>
                          <?php 
                            foreach($rs as $j){
                          ?>
