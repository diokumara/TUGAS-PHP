<?php 
    ...
    switch ($tombol) {
        ...
        header('Location:http://localhost/latihanphp/pertemuan-13/crud-tugas/createpelanggan.php');
            break;
    }
         // Landing Page
        header('Location:http://localhost/latihanphp/pertemuan-13/crud-tugas/pelanggan.php');
?>